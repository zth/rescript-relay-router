...
describe("RescriptRelayVitePlugin", () => {
  test("replaces modulenames in __$rescriptChunkName__ object properties", async () => {
    ...
    const resultPath = `src/RelayRouter.res.mjs`;
    const expected = {
      ...
      map: '{"version":3,"file":"test.mjs.map","sources":["test.mjs"],"sourcesContent":[null],"names":[],"mappings":"AAAA;AACA;AACA;AACA;AACA,UAAU,iDAAqC;AAC/C;AACA;AACA;AACA;AACA;AACA;AACA;AACA,UAAU,iDAAqC;AAC/C;AACA"}',
    };

...
describe("RescriptRelayVitePlugin", () => {
  test("looks up module names", async () => {
    ...
    expect(await plugin.resolveId(`@rescriptModule/RelayRouter`)).toEqual({
      id: path.resolve(process.cwd(), `./src/RelayRouter.mjs`),
    });
  });
  ...
  test("replaces modulenames in __$rescriptChunkName__ object properties", async () => {
    ...
    const expected = {
      ...
      map: '{"version":3,"file":"test.mjs.map","sources":["test.mjs"],"sourcesContent":[null],"names":[],"mappings":"AAAA;AACA;AACA;AACA;AACA,UAAU,6CAAqC;AAC/C;AACA;AACA;AACA;AACA;AACA;AACA;AACA,UAAU,6CAAqC;AAC/C;AACA"}'
    }

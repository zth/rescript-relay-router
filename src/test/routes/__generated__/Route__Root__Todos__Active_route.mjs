...
function makeLink(datePeriod, statuses, param) {
  ...
  return "/todos/active" + RelayRouter__Bindings.QueryParams.toString(queryParams);
}
...
function makeRouteKey(pathParams, queryParams) {
  return "Root__Todos__Active:" + Belt_Option.getWithDefault(RelayRouter__Bindings.QueryParams.getParamByKey(queryParams, "datePeriod"), "") + Belt_Option.getWithDefault(RelayRouter__Bindings.QueryParams.getParamByKey(queryParams, "statuses"), "");
}

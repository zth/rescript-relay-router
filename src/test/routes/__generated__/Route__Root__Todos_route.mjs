...
function makeLink(datePeriod, statuses, param) {
  ...
  return "/todos" + RelayRouter__Bindings.QueryParams.toString(queryParams);
}
...
function useActiveSubRoute(param) {
  ...
  return React.useMemo((function () {
                ...
                if (Belt_Option.isSome(Caml_option.nullable_to_opt(ReactRouter.matchPath("/todos/active", pathname)))) {
                  return "Active";
                } else if (Belt_Option.isSome(Caml_option.nullable_to_opt(ReactRouter.matchPath("/todos/inactive", pathname)))) {
                  return "Inactive";
                } else if (Belt_Option.isSome(Caml_option.nullable_to_opt(ReactRouter.matchPath("/todos/:todoId", pathname)))) {
                  return "Single";
                } else {
                  return ;
                }
...
function makeRouteKey(pathParams, queryParams) {
  return "Root__Todos:" + Belt_Option.getWithDefault(RelayRouter__Bindings.QueryParams.getParamByKey(queryParams, "datePeriod"), "") + Belt_Option.getWithDefault(RelayRouter__Bindings.QueryParams.getParamByKey(queryParams, "statuses"), "");
}

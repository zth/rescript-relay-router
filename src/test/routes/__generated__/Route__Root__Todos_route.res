...
@live
type subRoute = [#Active | #Inactive | #Single]

@live
let useActiveSubRoute = (): option<[#Active | #Inactive | #Single]> => {
  let location = RelayRouter.Utils.useLocation()
  React.useMemo1(() => {
    let {pathname} = location
    if RelayRouter.Internal.matchPath("/todos/active", pathname)->Belt.Option.isSome {
      Some(#Active)
    } else if RelayRouter.Internal.matchPath("/todos/inactive", pathname)->Belt.Option.isSome {
      Some(#Inactive)

...
let useActiveSubRoute = (): option<[#Active | #Inactive | #Single]> => {
  ...
  React.useMemo1(() => {
    ...
    if RelayRouter__Internal.matchPath("/todos/active", pathname)->Belt.Option.isSome {
      Some(#Active)
    } else if RelayRouter__Internal.matchPath("/todos/inactive", pathname)->Belt.Option.isSome {
      Some(#Inactive)
    } else if RelayRouter__Internal.matchPath("/todos/:todoId", pathname)->Belt.Option.isSome {
      Some(#Single)
    } else {
      None
    }

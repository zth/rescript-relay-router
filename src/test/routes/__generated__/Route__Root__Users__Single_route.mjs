...
function makeLink(userId, search, count, param) {
  ...
  return "/users/" + encodeURIComponent(userId) + RelayRouter__Bindings.QueryParams.toString(queryParams);
}
...
function makeRouteKey(pathParams, queryParams) {
  return "Root__Users__Single:" + Belt_Option.getWithDefault(Js_dict.get(pathParams, "userId"), "") + Belt_Option.getWithDefault(RelayRouter__Bindings.QueryParams.getParamByKey(queryParams, "search"), "") + Belt_Option.getWithDefault(RelayRouter__Bindings.QueryParams.getParamByKey(queryParams, "count"), "");
}

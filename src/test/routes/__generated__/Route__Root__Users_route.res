...
let useActiveSubRoute = (): option<[#Single]> => {
  ...
  React.useMemo1(() => {
    ...
    if RelayRouter__Internal.matchPath("/users/:userId", pathname)->Belt.Option.isSome {
      Some(#Single)
    } else {
      None
    }
